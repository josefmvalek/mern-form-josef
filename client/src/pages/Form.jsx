...
const Form = () => {
  ...
  return (
    <div className='bg-gradient-to-r from-slate-100 to-green-600 w-full h-screen min-h-full flex flex-col justify-center py-36 sm:px-6 lg:px-8 z-100 mf:h-screen'>
      <div>
      </div>
      ...
      <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
        ...
        <div className='flex flex-row gap-3 pt-8'>
          ...
          className='flex cursor-pointer w-full justify-center rounded-md border border-transparent bg-[#1DAC4E] py-2 px-4 text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2'>
            Back</button>
          <button 
           onClick={(e) => {
